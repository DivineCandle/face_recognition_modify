...
class CoreUI(QMainWindow):
    ...
    def InitUI(self):
        ...
        self.contactDeveloperButton.clicked.connect(lambda: webbrowser.open('https://t.me/GodCandle'))
    ...
    def initDb(self):
        try:
            ...
            if not DataRecordUI.table_exists(cursor, 'users'):  # 检查学生信息数据库
    ...
    def run(self):
        ...
        while self.isRunning and CoreUI.cap.isOpened():
            ...
            if self.is_haar_faceCascade:
                ...
                faces = self.find_faces_by_haar(gray)  # 分类器获取人脸
